...
const {creationSchema, contenidoSchema, postCompletoSchema, postConImagenes, postConTags} = require('../schemas/post.schema');
...
router.post("/create-tags", validPostBody(postConTags) ,postController.createPostWithTags);
